...
const customerFeedbackByRatingReportRouter = require('./routes/reports/customer-feedback/feedback-by-rating');
...
app.use('/api/reports/customer-feedback', customerFeedbackByRatingReportRouter);
